import type { OnlyEventsParam, PaginationParams, WithMutedParam, WithRelationshipsParam } from './common';

type GetAccountParams = WithMutedParam;

interface GetAccountStatusesParams extends PaginationParams, WithMutedParam, OnlyEventsParam {
